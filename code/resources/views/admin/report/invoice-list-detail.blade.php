...
@section('title', 'Invoice Lists Detail')

@section('content')

<ol class="breadcrumb breadcrumb-col-blue">
    <li><a href="{{ url('/admin') }}">Home</a></li>
    <li><a href="{{ url('/admin/report/quote-list') }}">Report Invoice Lists</a></li>
    <li class="active">Invoice Lists Detail</li>
</ol>
                ...
                <div class="card">
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-sm-12">.
                                <h2>Invoice Lists Detail<span class="pull-right"><a href="{{ url('/admin/report/invoice-list') }}" class="btn bg-green waves-effect" title="Back">
                    ...
                    <div class="body">
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    <td><span class="pull-right"><a href="{{ url('/admin/report/invoice-list-detail/'.$InvoiceLists->id.'/generate-pdf') }}" target="_blank" class="btn bg-blue-grey waves-effect" title="Back">
