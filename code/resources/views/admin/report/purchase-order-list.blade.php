                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover" id="purchase-order-table">
                                <thead>
                                    <tr>
...
@push('script')
    <script>
        var oTable;
        oTable = $('#purchase-order-table').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            searching: true,
...
//                                );
            ...
            ajax: '{!! route('report.purchase-order-list.data') !!}',
            columns: [
