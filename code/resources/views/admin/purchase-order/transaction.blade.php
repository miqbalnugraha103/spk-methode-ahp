    ...
    <div class="row clearfix">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                {!! Form::model($POLists, [
                    'method' => 'PATCH',
                    'url' => ['/admin/purchase-order-list/do_edit', $POLists->id],
                ...
                <div class="body">
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-xs-12">
                            ...
                            @else
                                <input type="text" name="purchase_order_list_code" id="purchase_order_list_code" class="form-control" value="{{ old('purchase_order_list_code').$POLists->purchase_order_list_code }}" placeholder="">
                ...
                <div class="header">
                    <div class="row clearfix">
                        <div class="col-xs-12 col-sm-12">
                            <h2>Purchase Order (Transaction) <span style="font-size: 15px;color: red;line-height:15px;">*</span>
                ...
                <div class="body">
                    ...
                    <div class="form-group text-center">
                        @if(count($list_detail) > 0)    
                            {!! Form::submit(isset($submitButtonText) ? $submitButtonText : 'Update Purchase Order', ['class' => 'btn bg-green btn-sm btn-block waves-effect', 'style' => 'font-size:19px;']) !!}
                        @else
                            <h4><div style="color: red;"><i>*Purchase Order (Transaction) tidak boleh kosong</i></div></h4>
                            <input type="button" disabled="disabled" value="Update Purchase Order" class="btn bg-green btn-sm btn-block waves-effect" style="font-size:19px;">
                        @endif
                    </div>
                    {!! Form::close() !!}
                </div>
