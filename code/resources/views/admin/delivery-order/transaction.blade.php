...
<ol class="breadcrumb breadcrumb-col-blue">
    ...
    <li class="active">Delivery Order Transaction</li>
</ol>
            ...
            <div class="card">
                <div class="header">
                    <div class="row clearfix">
                        <div class="col-xs-12 col-sm-12">
                            <h2>Delivery Order Transaction<span class="pull-right"><a href="{{ url('/admin/delivery-order-list') }}" class="btn bg-green waves-effect" title="Back">
                ...
                <div class="body">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <hr>
                            <label class="form-label" style="font-weight: 100; color: #aaa;">Delivery Order Name </label>&nbsp;:&nbsp;
                            <input type="hidden" name="delivery_order_list_code" id="delivery_order_list_code" class="form-control" value="{{ $DOLists->delivery_order_list_code }}"><h4><span class="label label-default">{{ $DOLists->delivery_order_list_code }}</span></h4>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                            <hr>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <hr>
                            <div class="form-float {{ $errors->has('pic_sales') ? 'has-error' : ''}}">
                                <label class="form-label" style="font-weight: 100; color: #aaa;">PIC Sales : <span style="font-size: 15px;color: red;line-height:15px;">*</span></label>
                                <input type="text" name="pic_sales" id="pic_sales" class="form-control" value="@if(old('pic_sales') != ''){{ old('pic_sales') }}@else{{ $DOLists->pic_sales }}@endif" placeholder="">
                                {!! $errors->first('pic_sales', '<p class="help-block">:message</p>') !!}
                            </div>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                            <hr>
                    ...
                    <hr>
                    {!! Form::submit(isset($submitButtonText) ? $submitButtonText : 'Update', ['class' => 'btn bg-green btn-sm btn-block waves-effect', 'id' => 'btn_create_all_do', 'style' => 'font-size:19px;']) !!}
                </div>
                {!! Form::close() !!}
            </div>
        </div>
            ...
            <div class="card">
                ...
                <hr>
                            ...
                            <tbody>
                                ...
                                @foreach($list_transaction as $list)
                                    <tr>
                                        ...
                                        <td align="center">
                                            <form action="{{ URL('/admin/delivery-order-list/update_data_qty_transaction').'/'. $list->id  }}" method="POST" id="my_form_{{ $no }}">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select name="product_name" id="product_idd" class="form-control" form="form_add">
                                    ...
                                    <td><input type="text" name="qty" value="" class="form-control" placeholder="" form="form_add"></td>
                                    <td align="center">
                                        <form action="{{ URL('/admin/delivery-order-list/do_save_qty_transaction')  }}" method="POST" id="form_add">
                    ...
                    <div class="form-group text-center">
                        <div class="form-group text-center">
                            <input type="button" id="btn_create_all_data" value="Update All" class="btn bg-green btn-sm btn-block waves-effect" style="font-size:19px;">
                        </div>
                    </div>
                    @else
...
@push('script')
    <script>
        ...
        $('#btn_create_all_data').on('click',function() {
            ...
            $.ajax({
                url : '{{ url("admin/delivery-order-list/create_all_do_transaction") }}',
                method : "POST",
                data : {
                        "id":do_id,
                ...
                success : function (data)
                {
                   ...
                   if(data != '')
                   {
                        swal({
                            position: 'center-end',
                            type: 'success',
                            title: 'Delivery Order data already Updated',
