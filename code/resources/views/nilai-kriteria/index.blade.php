...
@section('title', 'Perbandingan Kriteria (Untuk Menentukan Bobot Kriteria)')

@section('content')

    <ol class="breadcrumb breadcrumb-col-deep-purple">
        <li><a href="{{ url('/home') }}">Home</a></li>
        <li class="active">Perbandingan Kriteria (Untuk Menentukan Bobot Kriteria)</li>
    </ol>
                    ...
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-sm-12">
                                <h2>Perbandingan Kriteria (Untuk Menentukan Bobot Kriteria)</h2>
                            </div>
                        </div>
                    </div>
                    <div class="body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-sm-12">
                                <h2>Matriks Nilai Perbandingan</h2>
                            </div>
                        </div>
                    </div>
                    <div class="body">
